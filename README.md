...
**UPD:** Начиная с v0.2 появился доступ из LAN по VNC (при наличии монитора на сервере), пароль по умолчанию - `socksgw`. На клиенте можно использовать, например, [TigerVNC](https://sourceforge.net/projects/tigervnc/). 

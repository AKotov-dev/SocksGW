...
**Зависимости:** fping systemd zenity curl gtk2 polkit xraygui dnscrypt-gui dnsmasq iptables x11vnc  
...
**UPD-v0.2:** Доступ из LAN по VNC:5900, пароль по умолчанию - `socksgw`. На клиенте можно использовать, например, [TigerVNC](https://sourceforge.net/projects/tigervnc/).  
**UPD-v0.3:** Доступ из LAN по SSH:22, пароль по умолчанию - `ghbdtn`. На клиенте можно использовать, например, [Putty](https://www.chiark.greenend.org.uk/~sgtatham/putty/latest.html).  

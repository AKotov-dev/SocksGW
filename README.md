...
**UPD:** Начиная с v0.2 появился доступ из LAN по VNC, пароль по умолчанию - `socksgw`. На клиенте можно использовать, например, [TigerVNC](https://sourceforge.net/projects/tigervnc/). 

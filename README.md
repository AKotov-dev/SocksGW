...
**Примечание:** В сборках >= `v0.8.1` добавлен простой генератор конфигураций `XTLS-Reality` Клиент-Сервер (XRayGUI, кнопка "R"). Для общения с VPS добавлены FileZilla и Putty.
